...
# Asks AWS Security Token Service who the currently authenticated caller is. It returns details about the active credentials.
# Typical full response looks like:
# {
#   "UserId": "AIDAXXXXX...",
#   "Account": "123456789012",
#   "Arn": "arn:aws:iam::123456789012:user/your-user"
# }
# --query Account Filters that JSON and keeps only the Account field
# --output text Returns the value as plain text instead of JSON
